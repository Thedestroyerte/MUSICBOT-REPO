...
BOT_ID = int(getenv("BOT_ID", "6780487488"))
BOT_TOKEN = getenv("BOT_TOKEN")
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! .").split())
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID"))
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "༺ zero 𝐌𝐮𝐬𝐢𝐜 𝐁𝐨𝐭 ༻")
OWNER_ID = list(map(int, getenv("OWNER_ID", "7194620884").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Thedestroyerte")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "zero")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+BWruaT7T_iE5ZGJl")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/+x3M8fu6wkJM4Njc1")
...
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/13cccc652a151a3c675ba.jpg")
...
STREAM_IMG_URL = "https://telegra.ph/file/13cccc652a151a3c675ba.jpg"
...
if START_IMG_URL:
    if START_IMG_URL != "resources/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://telegra.ph/file/13cccc652a151a3c675ba.jpg"
