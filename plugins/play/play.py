...
from Zero.config import BANNED_USERS, lyrical
from Zero.nxz import get_command
from Zero import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from Zero.core.call import Zeroo
from Zero.utils import seconds_to_min, time_to_seconds
from Zero.utils.channelplay import get_channeplayCB
from Zero.utils.database import is_video_allowed
from Zero.utils.decorators.language import languageCB
from Zero.utils.decorators.play import PlayWrapper
from Zero.utils.bgtmusic.bk import command
from Zero.utils.formatters import formats
from Zero.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from Zero.utils.database import is_served_user
from Zero.utils.inline.playlist import botplaylist_markup
from Zero.utils.logger import play_logs
from Zero.utils.stream.stream import stream
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            if (
                ...
                return await mystic.edit_text(
                    "𝐓𝐡𝐢𝐬 𝐁𝐨𝐭 𝐂𝐚𝐧'𝐭 𝐏𝐥𝐚𝐲 𝐒𝐩𝐨𝐭𝐢𝐟𝐲 𝐓𝐫𝐜𝐤𝐬 𝐨𝐫 𝐏𝐥𝐚𝐲𝐥𝐢𝐬𝐭𝐬 𝐑𝐞𝐩𝐨𝐫𝐭 [Nzx 𝐂𝐡𝐚𝐭](https://t.me/+x3M8fu6wkJM4Njc1)."
                )
            if "track" in url:
                try:
            ...
            try:
                ...
                await mystic.edit_text(
                    "There's An Error In The Bot Then Report [Nxz 𝐂𝐡𝐚𝐭](https://t.me/+x3M8fu6wkJM4Njc1) AN Error"
                )
...
@app.on_callback_query(
    filters.regex("ZerooPlaylists") & ~BANNED_USERS
)
@languageCB
