...
from Zero.config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from Zero.nxz import get_command
from Zero import Carbon, YouTube, app
from Zero.utils.database import (delete_playlist, get_playlist,
                                       get_playlist_names,
                                       save_playlist)
from Zero.utils.decorators.language import language, languageCB
from Zero.utils.inline.play import close_keyboard
from Zero.utils.inline.playlist import (botplaylist_markup,
                                              get_playlist_markup,
                                              warning_markup)
from Zero.utils.pastebin import Bikashhbin
...
async def add_playlist(client, CallbackQuery, _):
    ...
    try:
        ...
        return await CallbackQuery.message.reply_text(
            text="☘ Successfully Playlist Added.\n │\n └Requested By : {0} \n\n Powered By  [Nxz](https://t.me/+x3M8fu6wkJM4Njc1)".format(CallbackQuery.from_user.mention),
